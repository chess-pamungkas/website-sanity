...
import type {HubCategoryListDoc} from '../lib/hubCategoriesReorder'
import {HubCategoryRowMenu} from './HubCategoryRowMenu'

type HubOrderableCategoryRowProps = {
  doc: HubCategoryListDoc
  dragHandleProps?: DraggableProvidedDragHandleProps | null
}

export function HubOrderableCategoryRow({doc, dragHandleProps}: HubOrderableCategoryRowProps) {
  ...
  return (
    <Flex align="center" width="100%">
      ...
      <HubCategoryRowMenu
        documentId={doc._id}
        documentTitle={getLocalizedString(doc.title) || 'Untitled category'}
      />
    </Flex>
  )
}
