/**
 * Inline critical CSS for /company/ — hero shell + gap under hero before deferred-styles-pages.css.
 * Keep min-height breakpoints in sync with src/assets/styles/company.scss + hero-page-shell mixins.
 */
export const COMPANY_CRITICAL_CSS = [
  "body.homepage-bg-1 .company+#main-container{min-height:0!important;flex-grow:0;contain:none}",
  ...
  "@media(max-width:767px){.company-page{padding-top:72px;margin-top:0}.company-page .features-products{padding:20px 0 30px!important}}",
  "@media(min-width:768px) and (max-width:1023px){.company-page{padding-top:32px;margin-top:0;margin-bottom:32px}.company-page .features-products{padding:16px 0 60px!important}}",
  "@media(min-width:1024px){.company-page{padding-top:28px;margin-top:0;margin-bottom:32px}.company-page .features-products{padding:16px 0 60px!important}}",
  "@media(min-width:1920px){.company-page{margin-bottom:48px}}",
].join("");
