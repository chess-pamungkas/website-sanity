...
export const COMPANY_CRITICAL_CSS = [
  ...
  "@media(max-width:767px){.company{position:relative;width:100vw;left:50%;margin-left:-50vw;margin-right:-50vw;min-height:calc(73px + 953px)!important;height:auto!important;padding-top:73px!important;padding-bottom:0;box-sizing:border-box;overflow:visible}}",
  ...
  "@media(max-width:767px){.company__hero-container{width:100%;max-width:100%;min-height:953px;height:auto;position:absolute;top:73px;left:50%;transform:translateX(-50%);margin:0 auto;border-radius:20px;background:#000;overflow:hidden;box-sizing:border-box;contain:layout}}",
