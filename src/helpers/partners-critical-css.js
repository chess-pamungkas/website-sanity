...
export const PARTNERS_HERO_CRITICAL_CSS = [
  ...
  ".partners-page+#main-container .header-offset-placeholder,.partners-page-community #main-container .header-offset-placeholder{height:0!important}",
  ...
  "@media(max-width:768px){.partners__hero-container{min-height:953px;height:auto;position:absolute;top:73px;left:50%;transform:translateX(-50%);width:100%;max-width:100%;box-sizing:border-box;border-radius:20px;background:#000;overflow:hidden}}",
