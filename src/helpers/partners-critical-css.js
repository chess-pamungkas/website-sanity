...
export const PARTNERS_HERO_CRITICAL_CSS = [
  ...
  "@media(min-width:768px) and (max-width:1023px){.partners__hero-container{top:73px;height:555px;min-height:555px;position:absolute;left:50%;transform:translateX(-50%);width:calc(100% - 48px);max-width:100%;padding-left:24px;padding-right:24px;box-sizing:border-box;border-radius:24px;background:#000;overflow:visible}}",
