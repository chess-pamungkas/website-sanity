    ...
    >
      ...
      <div className="search-container">
        <div className="search-frame">
          <input
            type="text"
            placeholder={t("energies_spreads_search_placeholder")}
            value={searchTerm}
        ...
        <table className="spreads-table">
          ...
          <thead className="table-header-section">
            ...
            <tr className="table-main-header">
              <th>{t("energies_spreads_table_header_product")}</th>
              <th className="table-header__ecn" colSpan="2">
                {t("energies_spreads_table_header_ecn_account")}
              </th>
              <th className="table-header__oqtima" colSpan="2">
                {t("energies_spreads_table_header_oqtima_account")}
              </th>
            </tr>
            {/* Sub Header Row */}
            <tr className="table-sub-header">
              <th>{t("energies_spreads_table_header_symbol")}</th>
              <th className="table-subheader__min">
                {t("energies_spreads_table_header_min")}
              </th>
              <th className="table-subheader__avg">
                {t("energies_spreads_table_header_avg")}
              </th>
              <th className="table-subheader__min">
                {t("energies_spreads_table_header_min")}
              </th>
